...
> (`specs/block-6/block-6.nets.yaml`, generated by `kicad/gen_block6.py`) was transcribed
> this pass and `kicad/generate_schematic.py --check` is clean. Findings, reconciled
