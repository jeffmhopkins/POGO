...
| 6 — Triple BP + Dist | 🚧 stages 1–5 done | 🚧 | G5+G6a | Split into 7 sections. **S1:** F_REF→400Hz, 2-pole. **S2:** DIST→SVF reorder. **S3:** BP3 selector (CD4053 U81). **S4:** per-band TILT (3 TL072 summer+inverter + knobs RV48-50). **S5:** variable DRIVE — stereo THAT2180 VCA per band (U85-90 + TL074 I/V U91-93 + Ec+ trims RV51-56), Ec+ from DRIVE knob+CV; mirrors block-4 cell; shared dB-law approximates per-mode gain (deviation); I/V inversion → reconcile in S7 mix polarity. First LM13700-OTA attempt was analog-flawed (input scaling) and rolled back; rebuilt on THAT2180 (user). **Pending:** S6 CLIP drivers, S7 two-scaler mix. |
| 7 — HP Filter | 🔲 | 🔲 | — | |
| 8 — LP Filter 2 | 🔲 | 🔲 | — | |
